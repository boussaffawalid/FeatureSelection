macro(OTB_CREATE_APPLICATION)
   ...
   set( APPLICATION_TARGET_NAME otbapp_${APPLICATION_NAME} )
	 	message(STATUS "Added " ${APPLICATION_TARGET_NAME})
   ...
   # Generate a quickstart script in the build dir
      ...
      if (WIN32)
        set(SCRIPT_CLI_SOURCE ${PROJECT_SOURCE_DIR}/CMake/otbcli_app.bat.in)
        ...
        set(SCRIPT_CLI_SOURCE ${PROJECT_SOURCE_DIR}/CMake/otbcli_app.sh.in)
      ...
      if (WIN32)
        set(SCRIPT_GUI_SOURCE ${PROJECT_SOURCE_DIR}/CMake/otbgui_app.bat.in)
        ...
        set(SCRIPT_GUI_SOURCE ${PROJECT_SOURCE_DIR}/CMake/otbgui_app.sh.in)
